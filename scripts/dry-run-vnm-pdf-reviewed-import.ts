...
async function analyzeCollisions(rows: NormalizedImportRow[]) {
  requirePostgresDatabaseUrl("dry-run-vnm-pdf-reviewed-import.ts");
...
async function run() {
  requirePostgresDatabaseUrl("dry-run-vnm-pdf-reviewed-import.ts");
  console.log("Phase 139F — VNM PDF reviewed preview-to-import dry-run only");
  console.log("=================================================================\n");
