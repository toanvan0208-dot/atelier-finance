...
export const industrySourcePackages: IndustrySourcePackage[] = [
  ...
  },
  {
    ...
    sectorCode: "CONSUMER_DISCRETIONARY",
    sectorName: "Consumer / Retail",
    classificationSystem: "provider_taxonomy_normalized",
    ...
    retrievedAt: "2026-07-01",
    reviewNote:
      "Vietstock profile for MWG is readable and shows the company under consumer discretionary / non-essential commerce / specialty retail taxonomy. Atelier Finance normalizes this as RETAIL for qualitative taxonomy only.",
    extractedQuote: null,
    warningCodes: [
      "RESEARCH_ONLY",
      "NEEDS_REVIEW",
  ...
  },
  {
    ...
    sectorName: "Consumer Staples / Hang tieu dung thiet yeu",
    classificationSystem: "provider_taxonomy_normalized",
    sourceLabel: "Vietstock - Ho so doanh nghiep VNM",
    sourceUrl: "https://finance.vietstock.vn/VNM/ho-so-doanh-nghiep.htm",
    sourceType: "provider_taxonomy",
    publicationDate: null,
    retrievedAt: "2026-07-01",
    reviewNote:
      "Vietstock profile for VNM is treated as a reviewed provider taxonomy source for dairy and consumer-staples exposure. Atelier Finance normalizes the qualitative mapping as CONSUMER_STAPLES_DAIRY; this remains research_only and needsReview.",
    extractedQuote: null,
    warningCodes: [
      "RESEARCH_ONLY",
      "NEEDS_REVIEW",
...
export const companyIndustrySourcePackages: CompanyIndustrySourcePackage[] = [
  ...
  },
  {
    ...
    roleType: "primary",
    segmentDescription:
      "Retail / consumer electronics / grocery and pharmacy distribution exposure based on reviewed Vietstock provider taxonomy and MWG business profile context.",
    mappingConfidence: "medium",
    sourceLabel: "Vietstock - Hồ sơ doanh nghiệp MWG",
    sourceUrl: "https://finance.vietstock.vn/MWG/ho-so-doanh-nghiep.htm",
    sourceType: "provider_taxonomy",
  ...
  },
  {
    ...
    industryCode: "CONSUMER_STAPLES_DAIRY",
    roleType: "primary",
    segmentDescription: "Dairy / nutrition / consumer staples exposure based on reviewed Vietstock provider taxonomy note.",
    mappingConfidence: "medium",
    sourceLabel: "Vietstock - Ho so doanh nghiep VNM",
    sourceUrl: "https://finance.vietstock.vn/VNM/ho-so-doanh-nghiep.htm",
    sourceType: "provider_taxonomy",
    ...
    retrievedAt: "2026-07-01",
    reviewNote:
      "Vietstock profile for VNM is readable and supports a provider-taxonomy review note for dairy and consumer-staples exposure. The mapping is normalized to CONSUMER_STAPLES_DAIRY and is not production-approved.",
    extractedQuote: null,
    warningCodes: [
      "RESEARCH_ONLY",
      "NEEDS_REVIEW",
