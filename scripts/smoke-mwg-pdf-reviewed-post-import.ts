...
async function run() {
  ...
  const summary = {
    ...
    assistant: {
      ...
      containsEps: assistant.allowedNumericValues.includes(4774),
      containsShares: assistant.allowedNumericValues.includes(1468456763),
      containsTotalDebt: assistant.allowedNumericValues.includes(29930.943),
  ...
  if (
    ...
    summary.runtime.eps !== 4774 ||
    summary.runtime.sharesOutstanding !== 1468456763 ||
    summary.runtime.totalDebt !== 29930.943 ||
    ...
    throw new Error("MWG post-import smoke verification failed.");
  }
}
