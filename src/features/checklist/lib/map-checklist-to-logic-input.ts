...
export type ChecklistStatementSnapshot = {
  ticker?: string;
...
export const mapChecklistToLogicInput = (snapshot: ChecklistStatementSnapshot): FinancialStatementInput => ({
  ...
  investingCashFlow: snapshot.investingCashFlow,
  financingCashFlow: snapshot.financingCashFlow,
