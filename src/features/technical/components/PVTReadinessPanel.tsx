...
import type { PVTReadinessData, PVTReadinessItem } from "../types";

type PVTReadinessPanelProps = {
  data: PVTReadinessData;
};

const itemVariant: Record<PVTReadinessItem["status"], "success" | "warning" | "neutral"> = {
  done: "success",
  needs_review: "warning",
  missing: "neutral",
};

const itemLabel: Record<PVTReadinessItem["status"], string> = {
  done: "Đã rõ",
  needs_review: "Cần xem lại",
  missing: "Chưa có",
};

const statusVariant: Record<PVTReadinessData["status"], "success" | "warning" | "neutral"> = {
  "Có thể sang Rủi ro": "success",
  "Nên kiểm tra thêm": "warning",
  "Chưa đủ điều kiện": "neutral",
};

export function PVTReadinessPanel({ data }: PVTReadinessPanelProps) {
