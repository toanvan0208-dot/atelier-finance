...
import type { TechnicalProgressData, TechnicalProgressStatus } from "../types";

type TechnicalProgressSidebarProps = {
...
export function TechnicalProgressSidebar({ data }: TechnicalProgressSidebarProps) {
  return (
