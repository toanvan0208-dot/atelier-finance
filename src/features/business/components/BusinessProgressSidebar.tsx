...
import type { BusinessProgressData, StepStatus } from "../types";

type BusinessProgressSidebarProps = {
...
export function BusinessProgressSidebar({ data }: BusinessProgressSidebarProps) {
  return (
