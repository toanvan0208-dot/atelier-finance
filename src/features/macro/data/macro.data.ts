...
const macroOverviewDashboard: MacroOverviewDashboardData = {
  regime: {
  ...
  metrics: [
    {
      ...
      value: "3.4",
      unit: "% YoY",
      period: "Tháng gần nhất",
      change: "+0.2 điểm %",
      status: "watch",
      explanation: "Lạm phát tăng nhẹ, cần theo dõi chi phí đầu vào.",
      source: "Mock data - cần thay bằng API thật",
      updatedAt: "Chưa realtime",
      isMock: true,
      sparkline: [3.0, 3.1, 3.2, 3.2, 3.4],
      detail: {
        definition: "CPI là chỉ số giá tiêu dùng, phản ánh mức tăng giá hàng hóa và dịch vụ.",
        currentReading: "CPI 3.4% YoY cho thấy áp lực giá còn trong vùng cần theo dõi.",
        whyItMatters: "CPI tăng mạnh có thể làm lãi suất khó giảm và gây áp lực chi phí.",
        transmission: ["CPI tăng", "Chi phí sinh hoạt tăng", "Lãi suất khó giảm", "Sức mua và biên lợi nhuận bị kiểm chứng"],
        affectedSectors: ["Bán lẻ", "Hàng tiêu dùng", "Thực phẩm", "Doanh nghiệp dùng nhiều đầu vào"],
        nextChecks: ["Biên lợi nhuận ngành", "Chi phí đầu vào", "Sức mua", "Tồn kho"],
      },
    },
    {
      id: "pmi",
      ...
      change: "+1.1 điểm",
      status: "support",
      explanation: "Sản xuất trên mốc 50, tín hiệu cải thiện.",
      source: "Mock data - cần thay bằng API thật",
      updatedAt: "Chưa realtime",
      isMock: true,
      sparkline: [49.1, 49.8, 50.1, 50.7, 51.2],
      detail: {
        definition: "PMI đo sức khỏe sản xuất; trên 50 thường là mở rộng.",
        currentReading: "PMI 51.2 cho thấy sản xuất cải thiện nhẹ.",
        whyItMatters: "PMI ảnh hưởng đến đơn hàng, sản lượng và nhu cầu logistics.",
        transmission: ["PMI vượt 50", "Đơn hàng cải thiện", "Sản xuất tăng", "Doanh thu ngành cần xác nhận"],
        affectedSectors: ["Logistics", "Khu công nghiệp", "Xuất khẩu", "Vật liệu"],
        nextChecks: ["Đơn hàng mới", "Sản lượng", "Doanh thu doanh nghiệp", "Biên lợi nhuận"],
      },
    },
    {
      id: "usd-vnd",
      ...
      change: "+1.3% MoM",
      status: "pressure",
      explanation: "Tỷ giá tăng, áp lực lên nhập khẩu và nợ ngoại tệ.",
      source: "Mock data - cần thay bằng API thật",
      updatedAt: "Chưa realtime",
      isMock: true,
      sparkline: [25120, 25240, 25310, 25400, 25450],
      detail: {
        definition: "USD/VND cho biết cần bao nhiêu VND để đổi một USD.",
        currentReading: "USD/VND tăng cho thấy VND chịu áp lực so với USD.",
        whyItMatters: "Tỷ giá ảnh hưởng chi phí nhập khẩu, nợ ngoại tệ và dòng vốn.",
        transmission: ["USD mạnh", "USD/VND tăng", "Chi phí nhập khẩu tăng", "Nợ ngoại tệ cần kiểm tra"],
        affectedSectors: ["Hàng không", "Nhập khẩu nguyên liệu", "Bất động sản", "Doanh nghiệp vay USD"],
        nextChecks: ["Nợ ngoại tệ", "Tỷ trọng nhập khẩu", "Khả năng chuyển giá", "Chi phí tài chính"],
      },
    },
    {
      id: "policy-rate",
      label: "Lãi suất điều hành",
      value: "4.5",
      unit: "%/năm",
      period: "Hiện tại",
      change: "Không đổi",
      status: "neutral",
      explanation: "Chi phí vốn ổn hơn, cần xem tín dụng thật.",
      source: "Mock data - cần thay bằng API thật",
      updatedAt: "Chưa realtime",
      isMock: true,
      sparkline: [5.0, 5.0, 4.75, 4.5, 4.5],
      detail: {
        definition: "Lãi suất điều hành là tín hiệu chính sách tiền tệ của ngân hàng trung ương.",
        currentReading: "Mức 4.5% cho thấy chính sách không còn quá căng.",
        whyItMatters: "Lãi suất ảnh hưởng chi phí vay, định giá tài sản và nhu cầu tín dụng.",
        transmission: ["Lãi suất ổn hơn", "Chi phí vốn dễ thở", "Tín dụng có thể cải thiện", "Cần kiểm chứng qua BCTC"],
        affectedSectors: ["Ngân hàng", "Bất động sản", "Chứng khoán", "Doanh nghiệp vay nợ cao"],
        nextChecks: ["Lãi vay thực tế", "Tăng trưởng tín dụng", "Chi phí tài chính", "Dòng tiền"],
      },
    },
    {
      id: "credit-growth",
      ...
      change: "+1.0 điểm %",
      status: "watch",
      explanation: "Tín dụng tăng, cần xem tiền vào sản xuất thật.",
      source: "Mock data - cần thay bằng API thật",
      updatedAt: "Chưa realtime",
      isMock: true,
      sparkline: [3.2, 4.1, 5.0, 5.8, 6.8],
      detail: {
        definition: "Tăng trưởng tín dụng đo tốc độ mở rộng cho vay trong nền kinh tế.",
        currentReading: "6.8% YTD là tín hiệu cải thiện nhưng chưa đủ để kết luận lan tỏa.",
        whyItMatters: "Tín dụng hỗ trợ tiêu dùng và đầu tư nếu đi vào hoạt động thật.",
        transmission: ["Tín dụng tăng", "Tiền vào nền kinh tế", "Nhu cầu có thể cải thiện", "Nợ xấu cần kiểm tra"],
        affectedSectors: ["Ngân hàng", "Bất động sản", "Chứng khoán", "Tiêu dùng"],
        nextChecks: ["Chất lượng tín dụng", "Nợ xấu", "Giao dịch bất động sản", "Doanh thu ngành"],
      },
    },
    {
      id: "foreign-flow",
      ...
      change: "Bán ròng",
      status: "pressure",
      explanation: "Dòng vốn ngoại rút làm tâm lý thận trọng hơn.",
      source: "Mock data - cần thay bằng API thật",
      updatedAt: "Chưa realtime",
      isMock: true,
      ...
      detail: {
        ...
        affectedSectors: ["Ngân hàng", "Chứng khoán", "Bất động sản", "VN30"],
        nextChecks: ["Nhóm bị bán ròng", "Thanh khoản", "Dòng tiền nội", "Định giá"],
      },
    },
    {
      id: "vnindex",
      ...
      change: "+2.4% MoM",
      status: "mixed",
      explanation: "Chỉ số hồi, cần kiểm tra độ rộng thị trường.",
      source: "Mock data - cần thay bằng API thật",
      updatedAt: "Chưa realtime",
      isMock: true,
      sparkline: [1235, 1250, 1268, 1272, 1280],
      detail: {
        definition: "VNINDEX là chỉ số đại diện cho thị trường cổ phiếu Việt Nam.",
        currentReading: "VNINDEX hồi lên 1,280 điểm nhưng cần xem số ngành cùng xác nhận.",
        whyItMatters: "Chỉ số chung cho biết tâm lý thị trường nhưng không thay thế phân tích ngành.",
        transmission: ["Chỉ số hồi", "Tâm lý cải thiện", "Dòng tiền phân hóa", "Cần xem ngành dẫn dắt"],
        affectedSectors: ["Ngân hàng", "Chứng khoán", "Bất động sản", "Bán lẻ"],
        nextChecks: ["Độ rộng thị trường", "Thanh khoản", "Ngành dẫn dắt", "PVT"],
      },
    },
    {
      id: "dxy",
      ...
      change: "+0.8 điểm",
      status: "pressure",
      explanation: "USD mạnh gây áp lực tỷ giá và dòng vốn.",
      source: "Mock data - cần thay bằng API thật",
      updatedAt: "Chưa realtime",
      isMock: true,
      sparkline: [102.8, 103.1, 103.7, 104.0, 104.2],
      detail: {
        definition: "DXY đo sức mạnh đồng USD so với rổ tiền tệ lớn.",
        currentReading: "DXY 104.2 cho thấy USD vẫn khá mạnh.",
        whyItMatters: "USD mạnh có thể gây áp lực tỷ giá và dòng vốn tại thị trường mới nổi.",
        transmission: ["DXY tăng", "USD mạnh", "USD/VND chịu áp lực", "Dòng vốn thận trọng"],
        affectedSectors: ["Nhập khẩu", "Vay USD", "Chứng khoán", "Hàng không"],
        nextChecks: ["USD/VND", "Dòng vốn ngoại", "Lãi suất liên ngân hàng", "Nợ ngoại tệ"],
      },
    },
  ],
  sectorTiles: [
    {
      ...
      status: "mixed",
      horizon: "Cả hai",
      shortReason: "Tín dụng hỗ trợ nhưng nợ xấu cần kiểm tra.",
      detail: {
        whyAffected: "Ngân hàng nhạy với tín dụng, lãi suất, thanh khoản và chất lượng tài sản.",
        keyChecks: ["Tăng trưởng tín dụng", "NIM", "Nợ xấu", "Chi phí dự phòng"],
        nextModule: ["Ngành", "BCTC", "Rủi ro"],
        warning: "Vĩ mô thuận hơn không đồng nghĩa mọi ngân hàng đều hấp dẫn.",
      },
    },
    {
      id: "real-estate",
      ...
      status: "watch",
      horizon: "Trung hạn",
      shortReason: "Nhạy với lãi suất, tín dụng và niềm tin.",
      detail: {
        whyAffected: "Bất động sản phụ thuộc chi phí vốn, khả năng bán hàng và thanh khoản tín dụng.",
        keyChecks: ["Dòng tiền", "Nợ vay", "Hàng tồn kho", "Trái phiếu"],
        nextModule: ["Ngành", "BCTC", "Định giá", "Rủi ro"],
        warning: "Hưởng lợi từ lãi suất thấp chưa đủ nếu dòng tiền yếu.",
      },
    },
    {
      id: "brokerage",
      ...
      status: "mixed",
      horizon: "Ngắn hạn",
      shortReason: "Hưởng thanh khoản, chịu áp lực dòng vốn.",
      detail: {
        whyAffected: "Nhóm chứng khoán nhạy với thanh khoản, tâm lý và giá trị giao dịch.",
        keyChecks: ["Thanh khoản thị trường", "Margin", "Tự doanh", "Dòng vốn ngoại"],
        nextModule: ["Ngành", "BCTC", "PVT"],
        warning: "Thanh khoản tăng không đồng nghĩa lợi nhuận bền vững.",
      },
    },
    {
      id: "retail",
      ...
      status: "watch",
      horizon: "Trung hạn",
      shortReason: "Cần xác nhận sức mua và biên lợi nhuận.",
      detail: {
        whyAffected: "Bán lẻ phụ thuộc thu nhập, lạm phát, tín dụng tiêu dùng và chi phí đầu vào.",
        keyChecks: ["Bán lẻ thực", "Doanh thu cửa hàng", "Biên gộp", "Tồn kho"],
        nextModule: ["Ngành", "BCTC", "Định giá"],
        warning: "Doanh thu tăng danh nghĩa chưa chắc là sức mua thật.",
      },
    },
    {
      id: "logistics",
      ...
      status: "support",
      horizon: "Cả hai",
      shortReason: "PMI và xuất khẩu cải thiện có thể hỗ trợ sản lượng.",
      detail: {
        whyAffected: "Logistics đi theo đơn hàng, sản lượng vận tải và thương mại quốc tế.",
        keyChecks: ["Sản lượng container", "Cước vận tải", "Đơn hàng", "Biên lợi nhuận"],
        nextModule: ["Ngành", "BCTC"],
        warning: "Sản lượng tăng cần đi cùng biên lợi nhuận.",
      },
    },
    {
      id: "materials",
      ...
      status: "support",
      horizon: "Trung hạn",
      shortReason: "Đầu tư công có thể hỗ trợ nhu cầu.",
      detail: {
        whyAffected: "Vật liệu hưởng lợi khi giải ngân hạ tầng chuyển thành đơn hàng thật.",
        keyChecks: ["Giải ngân", "Sản lượng", "Giá bán", "Biên gộp"],
        nextModule: ["Ngành", "BCTC", "Định giá"],
        warning: "Đầu tư công là bối cảnh, cần kiểm chứng hợp đồng và biên lợi nhuận.",
      },
    },
    {
      id: "industrial-park",
      ...
      status: "support",
      horizon: "Dài hạn",
      shortReason: "FDI và sản xuất hỗ trợ nhu cầu thuê đất.",
      detail: {
        whyAffected: "Khu công nghiệp phụ thuộc FDI, xuất khẩu, hạ tầng và chuỗi cung ứng.",
        keyChecks: ["FDI", "Tỷ lệ lấp đầy", "Giá thuê", "Quỹ đất"],
        nextModule: ["Ngành", "BCTC", "Định giá"],
        warning: "Cần kiểm tra quỹ đất và thời điểm ghi nhận doanh thu.",
      },
    },
    {
      id: "exporters",
      ...
      status: "mixed",
      horizon: "Cả hai",
      shortReason: "Đơn hàng cải thiện nhưng DXY và cầu ngoài còn rủi ro.",
      detail: {
        whyAffected: "Xuất khẩu chịu tác động từ cầu thế giới, tỷ giá và chi phí đầu vào.",
        keyChecks: ["Đơn hàng", "PMI thị trường chính", "Tỷ giá", "Biên lợi nhuận"],
        nextModule: ["Ngành", "BCTC", "Rủi ro"],
        warning: "Tỷ giá có thể vừa hỗ trợ doanh thu vừa tăng chi phí.",
      },
    },
  ],
};
...
export const macroJourneyData: MacroJourneyData = {
  ...
  dashboard: macroOverviewDashboard,
  snapshot: {
  ...
  thesisBuilder: {
    ...
    description:
      "Trả lời các câu hỏi ngắn để hệ thống ghi nhận bạn đang hiểu bối cảnh vĩ mô đến đâu.",
    tutorRule:
      "Hệ thống sẽ chọn số câu cần hỏi dựa trên phần kiến thức còn thiếu. Bản mock hiện dùng 8 câu cốt lõi.",
    questions: [
      {
        id: "context",
        label: "Câu 1",
