...
const HEADER_ALIASES: Record<string, keyof FinancialStatementImportRow> = {
  ...
  unitrevenue: "revenueUnit",
  netincomeunit: "netIncomeUnit",
  unitnetincome: "netIncomeUnit",
  operatingcashflowunit: "operatingCashFlowUnit",
  unitoperatingcashflow: "operatingCashFlowUnit",
  cfounit: "operatingCashFlowUnit",
  totalassetsunit: "totalAssetsUnit",
  unittotalassets: "totalAssetsUnit",
  equityunit: "equityUnit",
  totalequityunit: "equityUnit",
  unitequity: "equityUnit",
  totaldebtunit: "totalDebtUnit",
  unittotaldebt: "totalDebtUnit",
  currentassetsunit: "currentAssetsUnit",
  unitcurrentassets: "currentAssetsUnit",
  currentliabilitiesunit: "currentLiabilitiesUnit",
  unitcurrentliabilities: "currentLiabilitiesUnit",
  epsunit: "epsUnit",
  uniteps: "epsUnit",
  sharesoutstandingunit: "sharesOutstandingUnit",
  unitsharesoutstanding: "sharesOutstandingUnit",
