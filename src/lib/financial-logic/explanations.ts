...
export const METRIC_EXPLANATIONS = {
  ...
  priceChangePct: { beginner: "Mức thay đổi giá cho biết giá biến động bao nhiêu so với mốc trước.", warning: "Biến động giá không phải căn cứ quyết định độc lập.", commonMisread: "Giá tăng không chứng minh doanh nghiệp tốt hơn." },
