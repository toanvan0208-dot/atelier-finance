...
## 4. Source Metadata Required In Phase 26C
...
## 5. Do Not Claim Real Data Until

- Source name and URL are recorded.
- Legal/ToS status is reviewed.
- `asOf`, period, collection time, and unit are present.
