...
| implementationStatus | `first_real_csv_dry_run_reviewed` |
...
| fileImport | `csv_json` |
| firstRealDryRun | `ticker:FPT`, `dateRange:2025-01-01_to_2025-01-31`, `normalizedCount:17`, `rejectedCount:0`, `dbWrite:false` |
